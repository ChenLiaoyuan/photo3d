...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="css/photo3d_mobile.css"/>
		...
		<script type="text/javascript" src="js/photo3dScript_mobile.js"></script>
		<!-- <script src="https://use.fontawesome.com/7e216333f4.js"></script> -->
	</head>
	<body>
		<!--星空-->
		...
		<div class="buttonWrap">
			...
			<button class="button" style="right: 0px;color: #1d9d74;width: 105px;" onclick="uploadShare()">
