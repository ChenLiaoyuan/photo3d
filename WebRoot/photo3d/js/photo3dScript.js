...
$(function(){
	...
	$(".wrap").css("margin-top",(document.body.clientHeight-58)/2-150+"px");
});
...
function cubeHover(){
	...
	$(".wrap .cube").mouseout(function(){
		...
		$(".wrap .cube .front").css("transform","translateZ(125px)");
		$(".wrap .cube .back").css("transform","rotateY(180deg) translateZ(125px)");
		$(".wrap .cube .left").css("transform","rotateY(-90deg) translateZ(125px)");
		$(".wrap .cube .right").css("transform","rotateY(90deg) translateZ(125px)");
		$(".wrap .cube .up").css("transform","rotateX(90deg) translateZ(125px)");
		$(".wrap .cube .bottom").css("transform","rotateX(-90deg) translateZ(125px)");
	});
}
...
function mouseInElement(elementX,elementY,elementWidth,elementHeight){
	if(mouseX >= elementX-100 && mouseX <= elementX + elementWidth+200){
		if(mouseY >= elementY-100 && mouseY <= elementY + elementHeight+200){
			return true;
		}else{
			return false;
		}
